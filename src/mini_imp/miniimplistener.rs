...
/**
 * Enter a parse tree produced by {@link MiniImpParser#read}.
 * @param ctx the parse tree
 */
fn enter_read(&mut self, _ctx: &ReadContext<'input>) { }
/**
 * Exit a parse tree produced by {@link MiniImpParser#read}.
 * @param ctx the parse tree
 */
...
/**
 * Enter a parse tree produced by {@link MiniImpParser#asNumber}.
 * @param ctx the parse tree
 */
fn enter_asNumber(&mut self, _ctx: &AsNumberContext<'input>) { }
/**
 * Exit a parse tree produced by {@link MiniImpParser#asNumber}.
 * @param ctx the parse tree
 */
fn exit_asNumber(&mut self, _ctx: &AsNumberContext<'input>) { }
/**
 * Enter a parse tree produced by {@link MiniImpParser#asString}.
 * @param ctx the parse tree
 */
fn enter_asString(&mut self, _ctx: &AsStringContext<'input>) { }
/**
 * Exit a parse tree produced by {@link MiniImpParser#asString}.
 * @param ctx the parse tree
 */
fn exit_asString(&mut self, _ctx: &AsStringContext<'input>) { }
/**
